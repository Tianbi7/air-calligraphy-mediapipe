...
def create_hand_detector():
    ...
    hand_model_path = os.path.join(os.path.dirname(script_dir), "models", "hand_landmarker.task")
...
def create_pose_detector():
    script_dir = os.path.dirname(os.path.abspath(__file__))
    pose_model_path = os.path.join(os.path.dirname(script_dir), "models", "pose_landmarker_lite.task")
